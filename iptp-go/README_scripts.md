# 📜 iptp Example Scripts

Ready-to-use scripts that enhance your iptp experience!
...
3. **Create shell aliases:**
   ...
   alias ws='~/iptp-scripts/workspace.sh'
   alias qf='~/iptp-scripts/qf.sh'
   alias newp='~/iptp-scripts/newproject.sh'
   alias gits='~/iptp-scripts/gitstatus.sh'
   ```
...
- [SCRIPTING_GUIDE.md](../SCRIPTING_GUIDE.md) - Full guide to writing iptp scripts
- [README.md](../../README.md) - Main iptp documentation
...
**Remember:** These scripts work both inside and outside iptp, but they're optimized for use within iptp for automatic navigation and state management! 🚀
